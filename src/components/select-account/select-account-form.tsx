...
function AccountOptionButton({ account, selectedAccountId, optimisticPending, onSelect }: AccountOptionButtonProps) {
  ...
  return (
    <button
      ...
      className="w-full rounded-xl border border-border/80 bg-card px-4 py-3.5 text-left text-sm font-medium transition-colors hover:bg-muted/60 disabled:cursor-not-allowed disabled:opacity-75"
    >
